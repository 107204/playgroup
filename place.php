...
<body>
  ...
  <img src="pic/place/head.png" class="img-fluid" alt="Responsive image">
  ...
  <div class="container-fluid">
    <div class="card-deck">
        ...
        <a href="https://www.pickoneplace.com/search/program?uses=6&max_people=&county=&district=&maxHrPrice=&minHrPrice=&keywords=">
          <div class="card">
      ...
      <div class="col-xs-12 col-md-6 col-lg-3 courseitem">
        <a href="https://public.ntpc.gov.tw/resourcesPeopleSearch.do?orgId=oE1zXTpjv30=">
          <div class="card">
            <img class="card-img-top" src="pic/place/2.png" alt="Card image cap">
            <div class="card-body">
              <h3>新北市政府--公有場地租借網</h3>
            </div>
          </div>
      ...
      <div class="col-xs-12 col-md-6 col-lg-3 courseitem">
        <a href="http://www.tpqc.com.tw">
          <div class="card">
            <img class="card-img-top" src="pic/place/3.png" alt="Card image cap">
            <div class="card-body">
              <h3>台灣文創訓練中心</h3>
            </div>
          </div>
      ...
      <div class="col-xs-12 col-md-6 col-lg-3 courseitem">
        <a href="https://www.apspaceofsignseed.com">
          <div class="card">
            <img class="card-img-top" src="pic/place/4.png" alt="Card image cap">
            <div class="card-body">
              <h3>AP SPACE</h3>
            </div>
          </div>
      ...
      <div class="col-xs-12 col-md-6 col-lg-3 courseitem">
        <a href="http://camp.okgo.tw">
          <div class="card">
            <img class="card-img-top" src="pic/place/5.png" alt="Card image cap">
            <div class="card-body">
              <h3>玩全台灣--露營區</h3>
            </div>
          </div>
